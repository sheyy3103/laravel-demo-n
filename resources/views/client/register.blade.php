    ...
    <div class="container">
        ...
        <form action="{{ route('signup') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Enter user name..." style="border-radius: 0"
            ...
            <div class="form-group">
                ...
                <input type="password" class="form-control" placeholder="Enter password..." style="border-radius: 0"
